  ...
  return (
    <>
      ...
      <section className="flex flex-col justify-center items-center w-full gap-8 h-full max-h-[500px]">
        <Link
          href="/admin/products"
          className="w-full max-w-[250px] bg-white text-primaryColor px-10 py-2 rounded-lg hover:bg-gray-200 transition-all text-center"
        >
          Adicionar produtos
        </Link>
        <Link
        ...
        <Link
          href="#"
          className="max-w-[250px] bg-white text-primaryColor px-10 py-2 rounded-lg hover:bg-gray-200 transition-all w-full text-center"
        >
          Comandos abertas
        </Link>
        <button
          onClick={handleOpen}
          className="bg-white text-primaryColor px-10 py-2 rounded-lg hover:bg-gray-200 transition-all w-full max-w-[250px]"
        >
          Configurações
        </button>
